 ...
 * @returns {Boolean} true if given argument is an AST node, false otherwise
 */
 ...
 * @returns {Integer} Line number of code of the specified node. (LINES BEGIN FROM 1)
 */
 ...
 * @returns {Integer} Column number of code of the specified node (COLUMNS BEGIN FROM 0)
 */
