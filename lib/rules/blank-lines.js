                ...
                context.report({
                    ...
                    fix(fixer) {
                        ...
                        let line = sourceCode.getLine(topLevelNode) - 1, // The line number
                            ...
                            multipleLines = spacing.includes('\n'), // Whether there are multiple lines
                        ...
                        if (multipleLines) {
                            ...
                            while (strictCommentRegExp.test(sourceCode.getTextOnLine(line))) {
                                ...
                                if (text.includes("*/") && !text.includes("/*")) {
                                    ...
                                    line -= sourceCode.getText().slice(blockCommentStart, insertAt).split("\n").length;
                                    // Set the endpoint to the end of the line above the block comment
                                    insertAt = sourceCode.getText().slice(0, blockCommentStart).lastIndexOf("\n") + 1;
                                } else {
