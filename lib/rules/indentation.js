...
module.exports = {
    ...
    create: function(context) {
        ...
        function inspectAssemblyBlock(emitted) {
            ...
            const assemblyIndent = getIndentString(BASE_INDENTATION_STYLE, currentIndentLevel + 1);
            const assemblyIndentDesc = getIndentDescription(BASE_INDENTATION_STYLE, currentIndentLevel + 1);

            let indentRegExp = new RegExp("^" + assemblyIndent + "[^\\s(\/\*)]");
