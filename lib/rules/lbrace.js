...
module.exports = {
	...
	verify: function (context) {
		...
		context.on ('IfStatement', function (emitted) {
			...
			/**
			 * Ensure a whitespace between 'if' token and the opening parenthesis 'if (...)'
			 */
		...
		context.on ('ForStatement', function (emitted) {
			...
			/**
			 * Ensure a whitespace between 'for' token and the opening parenthesis 'for (...)'
			 */
		...
		context.on ('WhileStatement', function (emitted) {
			...
			/**
			 * Ensure a whitespace between 'while' token and the opening parenthesis 'while (...)'
			 */
