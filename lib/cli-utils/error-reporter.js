...
/**
 * Generate the specified number of hyphens
 * @param {Integer} charCount The number of hyphens to generate 
 * @returns {String} dashedLine charCount number of hyphens
 */
